...
**School Library** In this project, I will start building your school library app. In this initial step, I try to implement the classes to represent person,students and teachers.
...
```sh
  cd my-folder
  git clone https://github.com/Javed-Shahbaz/school_library.git
```
